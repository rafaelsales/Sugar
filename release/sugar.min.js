...
var p=Object,w=Array,x=RegExp,y=Date,z=String,A=Number,na=Function,E=Math,oa=Sugar.Object,F=Sugar.Array,G=Sugar.Date,pa=Sugar.String,qa=Sugar.Number,sa=p.prototype.toString,ta="function"===typeof x(/x/),ua=!("0"in new z("a")),va={},wa=/^\[object Date|Array|String|Number|RegExp|Boolean|Arguments\]$/,ya=xa("boolean",fa[0]),H=xa("number",fa[1]),I=xa("string",fa[2]),J=za(fa[3]),Ba=za(fa[4]),Ca=za(fa[5]),K=za(fa[6]);
